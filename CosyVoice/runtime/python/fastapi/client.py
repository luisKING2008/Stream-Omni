...
def main():
    ...
    if args.mode == "sft":
        ...
        payload = {"tts_text": args.tts_text, "spk_id": args.spk_id, "instruct_text": args.instruct_text}
        response = requests.request("GET", url, data=payload, stream=True)
    tts_audio = b""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", default="sft", choices=["sft", "zero_shot", "cross_lingual", "instruct"], help="request mode")
