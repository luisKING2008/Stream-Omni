...
def resample(data, resample_rate=22050, min_sample_rate=16000, mode="train"):
    ...
    for sample in data:
        ...
        if sample_rate != resample_rate:
            ...
            sample["speech"] = torchaudio.transforms.Resample(orig_freq=sample_rate, new_freq=resample_rate)(waveform)
...
def padding(data, use_spk_embedding, mode="train", gan=False):
    ...
    for sample in data:
        ...
        if mode == "inference":
            ...
            batch.update({"tts_text": tts_text, "tts_index": tts_index, "tts_text_token": tts_text_token, "tts_text_token_len": tts_text_token_len})
