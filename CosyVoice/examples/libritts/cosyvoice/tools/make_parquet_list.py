...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_utts_per_parquet", type=int, default=1000, help="num utts per parquet")
    parser.add_argument("--num_processes", type=int, default=1, help="num processes for make parquets")
    ...
    with open("{}/data.list".format(args.des_dir), "w", encoding="utf8") as f1, open("{}/utt2data.list".format(args.des_dir), "w", encoding="utf8") as f2, open("{}/spk2data.list".format(args.des_dir), "w", encoding="utf8") as f3:
