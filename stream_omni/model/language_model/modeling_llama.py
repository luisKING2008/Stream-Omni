...
class LlamaRotaryEmbedding(nn.Module):
    def __init__(
        ...
        self.rope_kwargs = {}
        if config is None:
            logger.warning_once("`LlamaRotaryEmbedding` can now be fully parameterized by passing the model config through the " "`config` argument. All other arguments will be removed in v4.45")
            self.rope_kwargs = {
                "rope_type": rope_type,
...
class LlamaLinearScalingRotaryEmbedding(LlamaRotaryEmbedding):
    ...
    def __init__(self, *args, **kwargs):
        logger.warning_once("`LlamaLinearScalingRotaryEmbedding` is deprecated an will be removed in v4.45. Please use " "`LlamaRotaryEmbedding`, which now also does linear scaling (simply pass the model config to __init__).")
...
class LlamaDynamicNTKScalingRotaryEmbedding(LlamaRotaryEmbedding):
    ...
    def __init__(self, *args, **kwargs):
        logger.warning_once("`LlamaDynamicNTKScalingRotaryEmbedding` is deprecated an will be removed in v4.45. Please use " "`LlamaRotaryEmbedding`, which now also does dynamic ntk scaling (simply pass the model config to " "__init__).")
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig, remove_layers=False):
